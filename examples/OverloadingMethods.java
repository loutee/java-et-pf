...
public class OverloadingMethods {
	...
	public static void print(double total) {
		System.out.printf("The total for your grocery store items is $%5.2f, " + "thanks for shopping with us!\n\n", total);
	}

	public static void print(double total, String storeName) {
		System.out.printf("The total for your grocery store items is $%5.2f, " + "thanks for shopping at %s!\n\n", total, storeName);
	}
}
